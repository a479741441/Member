  ...
  <tr valign="top">
    <td width="600">
      <form action="member_update.php" method="POST" name="form1" onSubmit="return check_form();">
        <p><font size="6" color="#FF0000">我要訂票</font></p>
        <div>
          <hr size="1" />
          ...
          <p><strong>票價</strong>：
            <input name="price" type="radio" value="A區500元" <?php if($row["price"]=="A") echo "checked";?>>A區500元
            <input name="price" type="radio" value="B區400元" <?php if($row["price"]=="B") echo "checked";?>>B區400元
            <input name="price" type="radio" value="C區300元" <?php if($row["price"]=="C") echo "checked";?>>C區300元
            <font color="#FF0000">*</font>
          </p>
          <p><strong>生　　日</strong>：
            <select name="year">
          ...
          <p><strong>訂購場次</strong>：
          	<input type="radio" name="game" value="1/3" <?php if($row["contact"]=="1/3") echo "checked";?>>1/3 
          	<input type="radio" name="game" value="1/4" <?php if($row["contact"]=="1/4") echo "checked";?>>1/4
          	<input type="radio" name="game" value="1/17" <?php if($row["contact"]=="1/17") echo "checked";?>>1/17
            <input type="radio" name="game" value="1/18" <?php if($row["contact"]=="1/18") echo "checked";?>>1/18
          </p>
        ...
        <p align="center">
          ...
          <input type="reset" name="reset" value="重新購票">
        </p>
      </form>
    </td>
    <td width="200">
